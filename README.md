## Enunciado
Realizar un programa que permita ingresar una tabla inicial, una tabla final y el multiplicador hasta el cual se desea calcular. 
El programa debe mostrar las tablas de multiplicar desde la tabla inicial hasta la tabla final. Si la tabla inicial es mayor que
la tabla final, debe mostrar un mensaje de error.
...
## Diagrama
<img width="1600" height="900" alt="WhatsApp Image 2026-09-24 at 9 14 44 AM" src="https://github.com/user-attachments/assets/a6dbeef1-d5fe-4a74-b414-a43239b708ef" />
